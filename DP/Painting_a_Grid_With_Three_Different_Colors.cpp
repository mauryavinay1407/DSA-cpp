...
Time Complexity      :  O(n * S * S * m), where S = total states i.e. 3 * 2^m-1
Space Complexity     :  O((n * S) + (S * m)) where n * S is because of memoization array t, and S * m is for storing columnStates
*/
class Solution {
public:
    vector<vector<int>> t;
